document.addEventListener("DOMContentLoaded", () => {
  ...
  // REAL-TIME FIRESTORE LISTENER FOR ARTICLES & COMMENTS
  db.collection("articles").orderBy("timestamp", "desc").onSnapshot(async (snapshot) => {
    ...
    // Ensure renderFeed is available and called
    if (typeof renderFeed === 'function') {
      renderFeed();
    }
    if (typeof checkAndScrollToHash === 'function') {
